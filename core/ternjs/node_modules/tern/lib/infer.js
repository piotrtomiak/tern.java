...
(function(root, mod) {
  ...
  var parse = exports.parse = function(text, options, thirdArg) {
    ...
    catch(e) { ast = acorn_loose.parse_dammit(text, options); ast.error = e; }
    return ast;
  };
  ...
  var typeFinder = exports.typeFinder = {
    ...
    MethodDefinition: function(node, scope) {
  ...
  exports.findPropRefs = function(ast, scope, objType, propName, f) {
    //find the type in hierarchy, which owns the property
    ...
    function isObjTypeProto(type) {
      ...
      while (type && type != objType) {
        //if property is overriden higher in the hierarchy, return false
    ...
    walk.simple(ast, {
      ...
      MethodDefinition: function(node, scope, c) {
